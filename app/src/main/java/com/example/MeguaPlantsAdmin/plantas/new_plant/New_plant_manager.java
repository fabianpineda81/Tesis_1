...
import com.example.MeguaPlantsAdmin.herramientas.Manejador_Bitmap;
import com.example.MeguaPlantsAdmin.herramientas.Manejador_notificaciones;
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        switch (conn){
                            case 1:
                                ...
                                montar_imagen1(imagen_muestra1,"imagen muestra");
                            ...
                            case 2:
                               conn++;
                                ...
                                montar_imagen1(imagen_muestra2,"imagen muestra2");
                                break;
                            case 3:
                                conn++;
                                modelo_planta.setLink_imagen_muestra_2(des_uri.toString());

                                montar_imagen1(imagen_muestra3,"imagen muestra3");
                            ...
                            case 4:
                                ...
                                montar_imagen1(imagen_muestra4,"imagen muestra4");
